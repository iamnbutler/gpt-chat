...
const initialConversations: ConversationHistoryItem[] = [
    {
        ...
        messages: [
            ...
            {
                role: "assistant",
                messages: [`The theory of relativity is a set of ideas and principles that Albert Einstein developed to explain the behavior of objects in motion. There are two main parts to the theory of relativity: special relativity and general relativity.
    ...
    },
    {
        ...
        messages: [
            {
                role: "user",
                messages: ["Does the No Cloning Theorem prove we live in a simulation?"],
            },
            {
                role: "assistant",
                messages: [
